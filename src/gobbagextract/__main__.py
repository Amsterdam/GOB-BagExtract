...
from gobcore.message_broker.config import BAG_EXTRACT, WORKFLOW_EXCHANGE, BAG_EXTRACT_QUEUE, BAG_EXTRACT_RESULT_KEY
...
def handle_bag_extract_message(msg):
